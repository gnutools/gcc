...
random_seed_i4 (GFC_INTEGER_4 *size, gfc_array_i4 *put, gfc_array_i4 *get)
{
  ...
  if (get != NULL)
	...
	memcpy (((char*) get->base_addr) + (SZ_IN_INT_4 - 1 - i) *
				 GFC_DESCRIPTOR_SPACING(get,0),
  ...
  if (put != NULL)
	...
	memcpy ((unsigned char*) seed + i * sizeof(GFC_UINTEGER_4),
		((char*) put->base_addr) + (SZ_IN_INT_4 - 1 - i) *
				 GFC_DESCRIPTOR_SPACING(put,0),
		sizeof(GFC_UINTEGER_4));
...
random_seed_i8 (GFC_INTEGER_8 *size, gfc_array_i8 *put, gfc_array_i8 *get)
{
  ...
  if (get != NULL)
	...
	init_rand_state (rs, false);
      ...
      /*  This code now should do correct spacings.  */
      for (size_t i = 0; i < SZ_IN_INT_8; i++)
	memcpy (((char*) get->base_addr) + i * GFC_DESCRIPTOR_SPACING(get,0), &seed[i],
  ...
  if (put != NULL)
    {
      ...
      /*  This code now should do correct spacings.  */
      for (size_t i = 0; i < SZ_IN_INT_8; i++)
	memcpy (&seed[i], ((char*) put->base_addr) + i * GFC_DESCRIPTOR_SPACING(put,0),
		sizeof (GFC_UINTEGER_8));

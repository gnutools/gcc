...
dnl The names count, extent, sspacing, dspacing, base, dest, rank, dim
dnl retarray, array, pdim and mspacing should not be used.
...
`	      }
      ...
      count[0]++;
      base = (const 'atype_name`*) (((const char*)base) + sspacing[0]);

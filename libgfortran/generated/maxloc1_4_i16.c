	...
	if (len <= 0)
	  *dest = 0;
	else
	  {
	    ...
	    for (n = 0; n < len; n++, src = (GFC_INTEGER_16*) (((char*) src) + delta))
	      {
#endif
	    ...
	    n = 0;
#endif
	    for (; n < len; n++, src = (GFC_INTEGER_16*) (((char*) src) + delta))
	      {
...
#endif
	result = 0;
	for (n = 0; n < len; n++, msrc += mdelta, src = (GFC_INTEGER_16*) (((char*) src) + delta))
	  {
...
#endif
	    if (back)
	      for (; n < len; n++, msrc += mdelta, src = (GFC_INTEGER_16*) (((char*) src) + delta))
	      	{

  ...
  while (continue_loop)
    {
      ...
      if (back)
	{
	  src = (GFC_UINTEGER_4*) (((char*) base) + (len - 1) * delta * len_array);
	  for (n = len; n > 0; n--, src = (GFC_UINTEGER_4*) (((char*) src) - delta * len_array))
	    {
	...
	{
	  src = base;
	  for (n = 1; n <= len; n++, src = (GFC_UINTEGER_4*) (((char*) src) + delta * len_array))
	    {
	      if (compare_string_char4 (len_array, src, len_value, value) == 0)
		{
		  result = n;
      ...
      *dest = result;
      ...
      count[0]++;
      base = (GFC_UINTEGER_4*) (((char*) base) + sspacing[0] * len_array);
      dest = (index_type*) (((char*) dest) + dspacing[0]);
      n = 0;
      while (count[n] == extent[n])
	{
	  count[n] = 0;
	  base = (GFC_UINTEGER_4*) (((char*) base) - sspacing[n] * extent[n] * len_array);
	  ...
	  if (n >= rank)
	    ...
	    {
	      count[n]++;
	      base = (GFC_UINTEGER_4*) (((char*) base) + sspacing[n] * len_array);
	    ...
	    GFC_LOGICAL_4 back, gfc_charlen_type len_array, gfc_charlen_type len_value)
{
  ...
  while (continue_loop)
      ...
      if (back)
	{
	  ...
	  for (n = len; n > 0; n--, msrc -= mdelta, src = (GFC_UINTEGER_4*) (((char*) src) - delta * len_array))
	    {
      ...
      else
	{
	  src = base;
	  msrc = mbase;
	  for (n = 1; n <= len; n++, msrc += mdelta, src = (GFC_UINTEGER_4*) (((char*) src) + delta * len_array))
	    {
	      if (*msrc && compare_string_char4 (len_array, src, len_value, value) == 0)
		{
		  result = n;

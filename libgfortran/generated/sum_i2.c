	...
	const index_type * const restrict pdim)
{
	...
	if (len <= 0)
	  *dest = 0;
	else
	  {
	    ...
	    for (n = 0; n < len; n++, src = (GFC_UINTEGER_2*) (((char*) src) + delta))
	      {
#endif
  ...
  result += *src;
      ...
      count[0]++;
      base = (GFC_UINTEGER_2*) (((char*)base) + sspacing[0]);
      dest = (GFC_UINTEGER_2*) (((char*)dest) + dspacing[0]);
      n = 0;
      while (count[n] == extent[n])
	{
	  ...
	  base = (GFC_UINTEGER_2*) (((char*)base) - sspacing[n] * extent[n]);
	  dest = (GFC_UINTEGER_2*) (((char*)dest) - dspacing[n] * extent[n]);
	  n++;
	  if (n >= rank)
	    {
	    ...
	    {
	      count[n]++;
	      base = (GFC_UINTEGER_2*) (((char*)base) + sspacing[n]);
	      dest = (GFC_UINTEGER_2*) (((char*)dest) + dspacing[n]);
	    }
	}
    }
}
	...
	gfc_array_l1 * const restrict mask)
{
  ...
  result = 0;
	for (n = 0; n < len; n++, msrc += mdelta, src = (GFC_UINTEGER_2*) (((char*) src) + delta))
	  {

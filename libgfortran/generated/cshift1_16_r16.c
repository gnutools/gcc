		...
		const GFC_INTEGER_16 * const restrict pwhich)
{
  ...
  while (rptr)
      ...
      if (unlikely(sh >= len || sh < 0))
	{
      ...
      src = (GFC_REAL_16*) (((char*) sptr) + sh * soffset);
      dest = rptr;
      if (soffset == sizeof (GFC_REAL_16) && roffset == sizeof(GFC_REAL_16))
	{
      ...
      sptr = (GFC_REAL_16*) (((char*) sptr) + sspacing0);
      ...
      while (count[n] == extent[n])
        {
          ...
          sptr = (GFC_REAL_16*) (((char*) sptr) - ss_ex[n]);
	  hptr = (GFC_INTEGER_16*) (((char*) hptr) - hs_ex[n]);
          ...
          if (n >= dim - 1)
          ...
          else
            {
              ...
              sptr = (GFC_REAL_16*) (((char*) sptr) + sspacing[n]);

  ...
  while (rptr)
    {
      ...
      *rptr = *src;
      ...
      src = (GFC_INTEGER_4*) (((char*)src) + sspacing0);
      rcount[0]++;
      scount[0]++;
      ...
      while (rcount[n] == rextent[n])
        {
          ...
          rptr = (GFC_INTEGER_4*) (((char*)rptr) - rspacing[n] * rextent[n]);
          n++;
          if (n == rdim)
            {
      ...
      while (scount[n] == sextent[n])
        {
          ...
          /* We could precalculate these products, but this is a less
             frequently used path so probably not worth it.  */
          src = (GFC_INTEGER_4*) (((char*)src) - sspacing[n] * sextent[n]);
          n++;
          if (n == sdim)
            {
              if (sptr && pad)
            ...
            {
              scount[n]++;
              src = (GFC_INTEGER_4*) (((char*)src) + sspacing[n]);
            }
        }
    }
}

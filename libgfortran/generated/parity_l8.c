	...
	const index_type * const restrict pdim)
{
  ...
  if (retarray->base_addr == NULL)
      ...
      for (n = 0; n < rank; n++)
	{
      ...
      GFC_DESCRIPTOR_SIZE (retarray) = sizeof (GFC_LOGICAL_8);
      GFC_DESCRIPTOR_SPAN (retarray) = sizeof (GFC_LOGICAL_8);
  ...
  result = result != *src;
		...
		src = (const GFC_LOGICAL_8 * restrict) (((char*) src) + delta);
	      }
      ...
      count[0]++;
      base = (GFC_LOGICAL_8*) (((char*)base) + sspacing[0]);
      ...
      while (count[n] == extent[n])
	{
	  ...
	  base = (GFC_LOGICAL_8*) (((char*)base) - sspacing[n] * extent[n]);
	  ...
	  if (n >= rank)
	    ...
	    {
	      count[n]++;
	      base = (GFC_LOGICAL_8*) (((char*)base) + sspacing[n]);

		     ...
		     int which)
{
  ...
  while (rptr)
      ...
      else
	{
	  ...
	  for (n = 0; n < len - shift; n++)
	    {
	      *dest = *src;
	      ...
	      src = (const GFC_INTEGER_8*) (((char*)src) + soffset);
	    }
      ...
      sptr = (const GFC_INTEGER_8 *) (((char*) sptr) + sspacing0);
      count[0]++;
      n = 0;
      while (count[n] == extent[n])
        {
          ...
          sptr = (const GFC_INTEGER_8 *) (((char*) sptr) - sspacing[n] * extent[n]);
          n++;
          if (n >= dim - 1)
            {
          ...
          else
            {
              ...
              sptr = (const GFC_INTEGER_8*) (((char*) sptr) + sspacing[n]);
            }
        }
    }

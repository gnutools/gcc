	...
	const index_type * const restrict pdim)
{
  ...
  if (retarray->base_addr == NULL)
      ...
      for (n = 0; n < rank; n++)
	{
      ...
      GFC_DESCRIPTOR_SIZE (retarray) = sizeof (GFC_LOGICAL_16);
      GFC_DESCRIPTOR_SPAN (retarray) = sizeof (GFC_LOGICAL_16);
  ...
  result = result != *src;
      ...
      count[0]++;
      base = (GFC_LOGICAL_16*) (((char*)base) + sspacing[0]);
      ...
      while (count[n] == extent[n])
	{
	  ...
	  base = (GFC_LOGICAL_16*) (((char*)base) - sspacing[n] * extent[n]);
	  ...
	  if (n >= rank)
	    ...
	    {
	      count[n]++;
	      base = (GFC_LOGICAL_16*) (((char*)base) + sspacing[n]);

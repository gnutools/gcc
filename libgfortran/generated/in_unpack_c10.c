  ...
  while (dest)
    {
      ...
      *dest = *(src++);
      ...
      dest = (GFC_COMPLEX_10*) (((char*)dest) + spacing0);
      count[0]++;
      ...
      while (count[n] == extent[n])
        {
          ...
          dest = (GFC_COMPLEX_10*) (((char*)dest) - spacing[n] * extent[n]);
          n++;
          if (n == dim)
            {
              dest = NULL;
            ...
            {
              count[n]++;
              dest = (GFC_COMPLEX_10*) (((char*)dest) + spacing[n]);
            }
        }
    }
}

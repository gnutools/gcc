  ...
  if (retarray->base_addr == NULL)
    {
	  ...
	  GFC_DESCRIPTOR_DIMENSION_SET(retarray, 0, 0,
	                    GFC_DESCRIPTOR_EXTENT(b,1) - 1, sizeof (GFC_INTEGER_8));
        }
      else if (GFC_DESCRIPTOR_RANK (b) == 1)
        {
	  GFC_DESCRIPTOR_DIMENSION_SET(retarray, 0, 0,
	                    GFC_DESCRIPTOR_EXTENT(a,0) - 1, sizeof (GFC_INTEGER_8));
        }
      else
        {
	  GFC_DESCRIPTOR_DIMENSION_SET(retarray, 0, 0,
          ...
          GFC_DESCRIPTOR_DIMENSION_SET(retarray, 1, 0,
			    ...
			    GFC_DESCRIPTOR_EXTENT(retarray,0) * sizeof (GFC_INTEGER_8));
        }
...
#define max(a,b) ((a) >= (b) ? (a) : (b))
  ...
  if (try_blas && rxspacing == sizeof (GFC_INTEGER_8)
  ...
  if (rxspacing == sizeof (GFC_INTEGER_8)
  ...
  else if (axspacing < ayspacing)
    {
      for (y = 0; y < ycount; y++)
	for (x = 0; x < xcount; x++)
	  dest[x*rxspacing + y*ryspacing] = (GFC_INTEGER_8)0;

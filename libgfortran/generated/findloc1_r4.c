  ...
  while (continue_loop)
    {
      ...
      if (back)
	{
	  src = (GFC_REAL_4*) (((char*) base) + (len - 1) * delta * 1);
	  for (n = len; n > 0; n--, src = (GFC_REAL_4*) (((char*) src) - delta * 1))
	    {
	      if (*src == value)
		{
		  result = n;
	...
	{
	  src = base;
	  for (n = 1; n <= len; n++, src = (GFC_REAL_4*) (((char*) src) + delta * 1))
	    {
	      if (*src == value)
		{
		  result = n;
      ...
      *dest = result;
      ...
      count[0]++;
      base = (GFC_REAL_4*) (((char*) base) + sspacing[0] * 1);
      dest = (index_type*) (((char*) dest) + dspacing[0]);
      n = 0;
      while (count[n] == extent[n])
	{
	  count[n] = 0;
	  base = (GFC_REAL_4*) (((char*) base) - sspacing[n] * extent[n] * 1);
	  ...
	  if (n >= rank)
	    ...
	    {
	      count[n]++;
	      base = (GFC_REAL_4*) (((char*) base) + sspacing[n] * 1);
	    ...
	    GFC_LOGICAL_4 back)
{
  ...
  while (continue_loop)
      ...
      if (back)
	{
	  ...
	  for (n = len; n > 0; n--, msrc -= mdelta, src = (GFC_REAL_4*) (((char*) src) - delta * 1))
	    {
	      if (*msrc && *src == value)
		{
		  result = n;
      ...
      else
	{
	  src = base;
	  msrc = mbase;
	  for (n = 1; n <= len; n++, msrc += mdelta, src = (GFC_REAL_4*) (((char*) src) + delta * 1))
	    {
	      if (*msrc && *src == value)
		{
		  result = n;

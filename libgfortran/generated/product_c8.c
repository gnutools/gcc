	...
	const index_type * const restrict pdim)
{
  ...
  if (retarray->base_addr == NULL)
      ...
      for (n = 0; n < rank; n++)
	{
      ...
      GFC_DESCRIPTOR_SIZE (retarray) = sizeof (GFC_COMPLEX_8);
      GFC_DESCRIPTOR_SPAN (retarray) = sizeof (GFC_COMPLEX_8);
  ...
  result *= *src;
		...
		src = (const GFC_COMPLEX_8 * restrict) (((char*) src) + delta);
	      }
      ...
      dest = (GFC_COMPLEX_8*) (((char*)dest) + dspacing[0]);
      n = 0;
      while (count[n] == extent[n])
	{
	  ...
	  dest = (GFC_COMPLEX_8*) (((char*)dest) - dspacing[n] * extent[n]);
	  n++;
	  if (n >= rank)
	    {
	  ...
	  else
	    {
	      ...
	      dest = (GFC_COMPLEX_8*) (((char*)dest) + dspacing[n]);
	    }
	}
    }
}

		...
		const GFC_INTEGER_16 * const restrict pwhich)
{
  ...
  if (sspacing[0] == 0)
    sspacing[0] = sizeof (GFC_INTEGER_1);
  if (rspacing[0] == 0)
  ...
  while (rptr)
      ...
      if (unlikely(sh >= len || sh < 0))
	{
      ...
      src = (GFC_INTEGER_1*) (((char*) sptr) + sh * soffset);
      dest = rptr;
      if (soffset == sizeof (GFC_INTEGER_1) && roffset == sizeof(GFC_INTEGER_1))
	{
      ...
      sptr = (GFC_INTEGER_1*) (((char*) sptr) + sspacing0);
      ...
      while (count[n] == extent[n])
        {
          ...
          sptr = (GFC_INTEGER_1*) (((char*) sptr) - ss_ex[n]);
	  hptr = (GFC_INTEGER_16*) (((char*) hptr) - hs_ex[n]);
          ...
          if (n >= dim - 1)
          ...
          else
            {
              ...
              sptr = (GFC_INTEGER_1*) (((char*) sptr) + sspacing[n]);

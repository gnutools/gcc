...
! { dg-final { scan-tree-dump-times {#pragma omp task affinity\(iterator\(integer\(kind=4\) jj=2:5:2, integer\(kind=4\) i=D\.[0-9]+:5:1\):b\[.* <?i>? \+ -1\](?:{lb: 0 sz: 4})?\) affinity\(iterator\(integer\(kind=4\) jj=2:5:2, integer\(kind=4\) i=D\.[0-9]+:5:1\):d\[\(.*jj \* 5 \+ .* <?i>?\) \+ -6\](?:{lb: 0 sz: 4})?\)} 1 "original" } }

! { dg-final { scan-tree-dump-times {#pragma omp task affinity\(iterator\(integer\(kind=4\) i=D\.[0-9]+:5:1\):b\[.* <?i>? \+ -1\](?:{lb: 0 sz: 4})?\) affinity\(iterator\(integer\(kind=4\) i=D\.[0-9]+:5:1\):d\[\(.*i \+ -1\) \* 6\](?:{lb: 0 sz: 4})?\)}  1 "original" } }
...
! { dg-final { scan-tree-dump-times {#pragma omp task affinity\(iterator\(integer\(kind=4\) k=7:4:-1, integer\(kind=8\) j=1:5:1\):b\[\(?\(integer\(kind=.\).* [jk] \+ .*[kj]\) \+ -1\](?:{lb: 0 sz: 4})?\) affinity\(iterator\(integer\(kind=4\) k=7:4:-1, integer\(kind=8\) j=1:5:1\):a\) affinity\(cc\)} 1 "original" } }

...
! { dg-final { scan-tree-dump-times {sub_scalar .&array_int.1.(?:{lb: 0 sz: 4})?,} 1 "original" } }
! { dg-final { scan-tree-dump-times "sub_scalar .&scalar_t1," 1 "original" } }
...
! { dg-final { scan-tree-dump-times {sub_scalar .\(struct t1 .\) array_class_t1_ptr._data.data \+} 1 "original" } }
...
! { dg-final { scan-tree-dump-times {\.data = \(void .\) &array_t1.0.(?:{lb: 0 sz: 4})?;} 1 "original" } }
